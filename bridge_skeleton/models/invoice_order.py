...
class WkSkeleton(models.TransientModel):
    ...
    def create_order_invoice(self, orderId, ecommerceInvoiceId=False):
        ...
        try:
            ...
            if not invoiceId:
                invoiceId = saleObj._create_invoices().ids
            ...
            if invoiceId:
                ...
                invoiceId = 0
            _logger.info("final return {} {} {}".format(status, statusMessage,
                                              invoiceId))
            return {
                'status': status,
                'status_message': statusMessage,
                'invoice_id': invoiceId and invoiceId or 0
            }
