...
class WkSkeleton(models.TransientModel):
    ...
    def confirm_odoo_order(self, orderId):
        ...
        try:
            ...
            # try:
            #     for picking in saleObj.picking_ids:
            #         if picking.state == "assigned":
            #             is_picking_blank = True
            #             for ln in picking.move_line_ids_without_package:
            #                 if ln.qty_done:
            #                     is_picking_blank = False
            #                     break
            #                 else:
            ...
            # except Exception as e:
            #     _logger.info("Exception while validating picking, "
            #                  "{}".format(str(e)))
        except Exception as e:
